...
\arguments{
  ...
  \item{xticklabels}{ Specifies the text to associate with each group defined as ticks on the x-axis.}
  \item{yticklabels}{ Specifies the text to associate with each tickmark on the y-axis.}
  ...
  \item{ct}{Plots the specified measure of central tendancy, taking one of: 'mode', 'mean', 'median'}
  \item{ylims}{Sets the y axis limits. By default this is inferred from the data}
  \item{lbound}{Sets a strict limit on the lower extent of the posterior distribution. E.g. useful for values that must be strictly positive.}
  \item{ubound}{Sets a strict limit on the upper extent of the posterior distribution. E.g. useful for proportions that must be strictly less than one.}
